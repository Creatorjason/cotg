...
const Hero = () => {
  return (
    <div className='py-2 md:py-10 flex flex-col gap-4 sm:gap-8'>
        <h1 className={'text-5xl sm:text-6xl md:text-7xl text-center  ' + fugaz.className}><span className='textGradient'>Stay</span> sharp wherever you are, <span className='textGradient'> CutzOnTheGO <br/></span>brings the barber to you</h1>
